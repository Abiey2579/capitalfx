...
const SideContainer = () => {
  return (
    <div className="col-xl-6 col-lg-12 col-md-9 login-cover-background">
      <div className="row d-flex justify-content-center align-items-center">
        <div className="col-xl-10 col-lg-12 col-md-9 text-center">
          <img src={UndrawImage} className="login-illustration"></img>
          <div className="capitalfx-logo">
            <span className="text-dark-blue">
              Capital<span className="text-sky-blue">FX</span>
            </span>
          </div>
          <p className="login-side-description text-dark-blue">
